...
slabo=0
for t in test-zbirka.js test-posodobitev.js test-logika.js test-igranje.js test-tap.js \
         test-kviz.js test-kviz2.js test-matko.js test-matko-racuni.js test-olly.js \
         test-barvica.js test-kito.js; do
